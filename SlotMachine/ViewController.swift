...
//  SlotMachine
//
//  Created by David Vences Vaquero on 25/3/15.
...
class ViewController: UIViewController {
    ...
    var resetButton: UIButton! //normalmente no se generan IBOutlets para los botones, pero los necesitamos para oder acceder a ellos en código como objetos, y no solo editar la acción.
    ...
    let kNumberOfContainers = 3 //Rerpesenta el número de columnas
    let kNumberOfSlots = 3 //Representa el número de filas
    ...
    func setupFourthContainer (containerView: UIView){
        ...
        self.resetButton.setTitle("Reset", forState: UIControlState.Normal) //podemos tener titulos distintos para distintos estados del boton, como apretado o seleccionado
        self.resetButton.setTitleColor(UIColor.blueColor(), forState: UIControlState.Normal)
        self.resetButton.titleLabel?.font = UIFont(name: "Superclarendon-Bold", size: 12) //añadimos el interrogante porque quizas no exista la titleLabel. No es imprescindible. Pero ahorramos memoria.
        self.resetButton.backgroundColor = UIColor.lightGrayColor()
        self.resetButton.sizeToFit()
        self.resetButton.center = CGPoint(x: containerView.frame.width * kEighth, y: containerView.frame.height * kHalf)
        self.resetButton.addTarget(self, action: "resetButtonPressed:", forControlEvents: UIControlEvents.TouchUpInside) //No olvidar los dos puntos de resetButtonPressed: !!! sin ellos no funciona. Sirven para pasar los parámetros. La función IBAction la escribimos despues arriba.
